    ...
    Alpine.data('configApp', () => ({
            ...
            fetch('/api/config')
                ...
                .then(data => {
                    ...
                    this.config = {
                        ...
                        credentialsFile: data.googleSheets?.credentialsFile || './service-account.json'
                    };
        ...
        saveConfig() {
            ...
            if (saveBtn) {
                ...
                if (this.config.webAuthPassword && this.config.webAuthPassword !== '********') {
                ...
                .catch(error => {
                    ...
                    this.showErrorToast(`Gagal menyimpan konfigurasi: ${error.message}`);
                })
                .finally(() => {
                    this.isSaving = false;
                    if (saveBtn) {
